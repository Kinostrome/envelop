...
Envelop comes with a dedicated package for testing purposes. You can use it to test your plugin or you are whole Envelop, by replacing or mocking other plugins/phases.
...
You can use `modifyPlugins` to modify the plugins that are part of your execution:
...
<Callout type="info">**Note**: Replacing whole phases might affect plugin execution, so use it carefully!</Callout>
